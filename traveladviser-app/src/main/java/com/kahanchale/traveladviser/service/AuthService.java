...
public class AuthService {
    ...
    public LoginResponse register(RegisterRequest request) {
        ...
        return new LoginResponse(token, savedUser.getEmail(), savedUser.getName(), "User registered successfully", savedUser.getId());
    }
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        return new LoginResponse(token, user.getEmail(), user.getName(), "Login successful", user.getId());
    }
}